...
class PreprocessingOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--mask_opt', type = int, default = 0, help = 'Mask option. 0: mask CT + MRI (no effect if no_mask = True). 1: mask CT only. 2: mask MRI only.') 
        parser.add_argument('--tanh', default = False, action = 'store_true', help = 'normalizes data in range [-1;1]')
