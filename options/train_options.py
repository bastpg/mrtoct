...
class TrainOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type = str, default = 'custom', help = 'Network architecture: [custom, pix2pix, cyclegan, medgan, filasgan, idcgan]')
        parser.add_argument('--netG', type = str, default = 'UNet', help='Custom Network Generator: [UNet; ResNet9; FilaSGan]')
        ...
        parser.add_argument('--loss_metric', type = str, default = 'mae', help = 'Main loss metric. If l1_l2, metric becomes [mae, mse].')
        ...
        #parser.add_argument('--tanh', default = False, action = 'store_true', help = 'use tanh activation instead of sigmoid activation')
        parser.add_argument('--discls', default = False, action = 'store_true', help = 'use mse as discriminator loss.')
